...
import HistoryTimelineModal from "@/components/HistoryModalTimeline";
    ...
    >
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button onClick={openNew} className="btn-outline flex gap-1">
            <Plus size={14} /> Tambah
          </button>
          <button onClick={handleExport} className="btn-outline flex gap-1">
            <FileSpreadsheet size={14} /> Export
          </button>
          <button onClick={reload} className="btn-outline flex gap-1">
